...
class DBTExecuter():
    ...
    def run_command(self):
        ...
        prev_cwd = Path.cwd()
        print(prev_cwd)
        os.chdir(f"./{self.dbt_project}")

        self.dbt_command.extend(["--profiles-dir", "../."])
        ...
        try:
            ...
            print("Error: did not successfully run dbt command:")
            print(f"\t{self.dbt_command}")
        finally:
            os.chdir(prev_cwd)
